...
class DCBatchNormFunction(torch.autograd.Function):
    ...
    def forward(ctx, input_4: Tensor, weight: Tensor, bias: Tensor, 
        ...
        # Always save original weight and statistics
    ...
    @staticmethod
    def backward(ctx, grad_4: Tensor) -> Tuple[Tensor, None, None, None, None, None, None, None, None, None]:
        delta_pp, delta_np, delta_pn, delta_nn = init_backward(
            grad_4, ctx.is_output_layer)

        # Always split weights on-the-fly in backward
